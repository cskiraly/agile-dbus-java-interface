...
@DBusInterfaceName("org.eclipse.agail.protocols.BLEProcotol")
public interface BLEProtocol extends Protocol, DBusInterface {
	
	public static String AGILE_INTERFACE = "org.eclipse.agail.protocols.BLEProcotol";
